# Ais Message 커스텀 서버
## 프로젝트 설명
- AIS 원시코드를 랜덤으로 생성하여 출력하는 간단한 서버입니다.
- AIS 레이더가 전송하는 선박 신호를 만들고 전송합니다.
...
사용 근거
- 사용자가 다수가 아니었고 테스트 및 시뮬레이션 목적으로 사용할 목적이었기 때문에 UDP 보다는 신뢰성 있는 TCP 소켓 통신방식을 채택했습니다.
...
- 인코딩 및 계산 과정은 아래 참조사이트에 기술된 내용을 기반으로 구현하였습니다.
